...
To start tracking user activity on your website, add the Passwordless tracking script to your site's HTML.
...
If you are self-hosting Passwordless `app.rybbit.io` will be domain of your Passwordless instance.
