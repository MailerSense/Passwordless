defmodule PasswordlessWeb.Components.RouteTree do
  @moduledoc """
  ...
  def route(assigns) do
    ...
    >
      ...
      >
        <div class="absolute left-[-56px] w-[46px] flex justify-end">
  ...
  defp route_id(route), do: "path_#{route.path}_#{route.verb}" |> String.replace("/", "_") |> String.replace(":", "_")
