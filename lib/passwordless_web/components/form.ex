defmodule PasswordlessWeb.Components.Form do
  @moduledoc """
  ...
  def radio_group(assigns) do
    assigns =
      assign_defaults(assigns, radio_classes(field_has_errors?(assigns)))
  ...
  def form_field_error(assigns) do
    assigns =
      assign(assigns, :translated_errors, generated_translated_errors(assigns.form, assigns.field))
