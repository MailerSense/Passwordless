defmodule PasswordlessWeb.Components.ThemeSwitch do
  ...
  def wide_theme_switch(assigns) do
    ...
    <button
      ...
      id={@id}
      class={[
        "p-1 px-1.5 flex rounded-full items-center justify-center bg-gray-200 dark:bg-gray-900",
        @class
      ]}
    >
      <div class={[
        ...
        "bg-white text-gray-900 shadow-1 dark:bg-transparent dark:shadow-none dark:text-gray-400",
        "grow"
      ]}>
      ...
      <div class={[
        "flex items-center justify-center py-2.5 px-6 text-sm font-semibold leading-tight rounded-full whitespace-nowrap select-none gap-2.5",
        "dark:bg-gray-700 dark:text-white dark:shadow-1",
        "grow"
      ]}>
