defmodule PasswordlessWeb.Components.Accordion do
  @moduledoc false
  ...
  def accordion(assigns) do
    assigns =
      assign_new(assigns, :container_id, fn -> "accordion_#{Ecto.UUID.generate()}" end)
    ...
    <div
      id={@container_id}
      class={["pc-accordion-container", @class]}
      {@rest}
  ...
  defp js_attributes("item", "alpine_js", _container_id, i, _) do
    %{
      ...
      ":class": "expanded ? 'pc-accordion-item--expanded' : 'pc-accordion-item-marker'"
    }
  end
