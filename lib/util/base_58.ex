defmodule Util.Base58 do
  ...
  Additionally, B58 encodes and decodes data in a consistent manner - plain binary in, plain binary out. No additional steps, clever hacks, or assumptions are made with regard to input and output. Furthermore, the library is relatively consistent with the approach taken in the Elixir core `Base` library.
  ...
  ## Examples
      ...
      iex> B58.encode58("Some chicken is better than no chicken")
      "DLrwGKtrzZkxaLwqpwBBbkgFiEGTYhhzEpjXuj5R2DZPGzbXfeVK"

      iex> B58.encode58("Some chicken is better than no chicken", alphabet: :btc)
      "DLrwGKtrzZkxaLwqpwBBbkgFiEGTYhhzEpjXuj5R2DZPGzbXfeVK"

      iex> B58.encode58("The T in Tacos stands for terrific", alphabet: :flickr)
      "2UF2YLgW2MQSutxJWpcW6afxo1YbVm4ZnXociLQ1eExXRwK"

      iex> "536D656C6C73206C696B652061206C6F636B657220726F6F6D20696E2068657265" |> Base.decode16!() |> B58.encode58(alphabet: :ripple)
  ...
  ## Examples
      ...
      iex> B58.encode58_check!("Lost my sauce, sorry boss.", 0)
      "1GKJd5qu8gaFbd4tHVPF6q8ZtzER5ttJSwLTN2A5MT"

      iex> B58.encode58_check!("Lost my sauce, sorry boss.", 1, alphabet: :btc)
      "29cSfWnUdLoFyrRquaF4fQ2xnKSMg8TWenhe89Mc95"

      iex> B58.encode58_check!("Lettuceless Burritos", "m", alphabet: :ripple)
      "kyo6DdGZMd7yc1EmNVz2jh4sEc3qUNBY1D"

      iex> "466F6F20426172204578616D706C657320617265207265616C6C792064616D6E20737475706964" |> Base.decode16!() |> B58.encode58_check!("2", alphabet: :flickr)
  ...
  def encode58_check!(data, version, opts \\ []) do
    data |> version_binary(version) |> do_encode58_check(opts)
  end
  ...
  ## Examples
      ...
      iex> B58.encode58_check("So Afraid of failure", <<1>>, alphabet: :btc)
      {:ok, "XwmCCcWGbEjGsJk4THsxw28EcQuz6TYyu"}

      iex> B58.encode58_check("Incapable coworker lacking understanding what a byte is", <<1, 2>>, alphabet: :btc)
      {:error,
  ...
  ## Examples
      ...
      iex> B58.version_encode58_check!(<<5, "256 versions ought to be enough for anyone">>)
      "3WGnVcRSYcejzu1tmjqG36i8zGFhPH5v7399paTXYSvCQPRsqSa86CcnRUPVJxXw"

      iex> B58.version_encode58_check!("1Mad Lad", alphabet: :ripple)
      "vx82hmfYGg4kdDK5"

      iex> B58.version_encode58_check!(<<255, "Push the limits until the car starts">>, alphabet: :flickr)
  ...
  ## Examples
      ...
      iex> B58.decode58!("59QpGHkaSK8tngYpe9h17cseyAEGc")
      "Cheese Platter Please"

      iex> B58.decode58!("asDvaq68ktFaubY7KsnvBFMMD5Q8cd9PhGma3YcPqoWXX2aJoiaK1kc65gn", alphabet: :ripple)
      "Decode using the alphabet it was encoded in"

      iex> B58.decode58!("2zPJuvDvDNbavb7zdUVM9niBSHNTjPni85f8hPLJ119awVLKud3kWU5LsRGiqkzav8wD6MFj2QshN3b8SyTEpkG2pYcSAioeUUDe6wqhigji4vkBVQoBJ9mPLmySgjQyy8FrYu3rd", alphabet: :btc) |> Base.decode16!()
  ...
  ## Examples
      ...
      iex> B58.decode58("59QpGHkaSK8tngYpe9h17cseyAEGc", alphabet: :btc)
      {:ok, "Cheese Platter Please"}

      iex> B58.decode58("2nePN7syqoQe2mfeY", alphabet: :flickr)
      {:ok, "Hello Sailor"}

      iex> B58.decode58("02nePN7syqoQe2mfeY", alphabet: :flickr)
  ...
  ## Examples
      ...
      iex> B58.decode58_check!("12nwcb8vmxv3waEzzPtaY3XBmWbwvGvqw", alphabet: :flickr)
      {"Backstrom for Selke", <<0>>}

      iex> B58.decode58_check!("ftyYJFWLdZWzNfyFqPGXGpxM6aFNnTkqmz1QwcoT3eQAQPb9V4bRQScejwWQWTR8", alphabet: :ripple)
      {"No one wants to play Sega Genesis with you", <<14>>}

      iex> B58.decode58_check!("2mzYnhGdFMacGVTrvyZsnqDGPqWFefouMQA")
  ...
  ## Examples
      ...
      iex> B58.decode58_check("QGgq7M6oMmgLQiWY9SUgo5QoaK6FH44nM")
      {:ok, {"Backstrom for Selke", <<255>>}}

      iex> B58.decode58_check!("17B1aKcMUBrrX9t6Y7ZUSkDoedGLiybgnJ", alphabet: :flickr)
      {"Hot Delicious Treats", <<0>>}

      iex> B58.decode58_check("QGgq7M6oMmgLQiWY9SUgo5QoaK6FH44n_", alphabet: :btc)
      {:error, "non-alphabet digit found: \\"_\\" (byte 95)"}

      iex> B58.decode58_check("QGgq7M6oMmgLQiWY9SUgo5QoaK6FH44nM", alphabet: :ripple)
  ...
  ## Examples
      ...
      iex> B58.version_decode58_check!("2XLgTmqxf6wu4zAwBAb2hvezGWht")
      "mSeal of Quality"

      iex> B58.version_decode58_check!("5XtVTWqqaYj7VUodxQwwgnioaGCoB1fVFzMSXLfQWBiUmsEfo6oJ73CpJojLDuYa3fFE77uvAax4ctzBT17me", alphabet: :flickr)
      "SEvery library says it is fast. Surely, they are all fast."

      iex> B58.version_decode58_check!("YXUaKUi6gkm3DRXp8hDrbB", alphabet: :ripple)
  ...
  ## Examples
      ...
      iex> B58.version_decode58_check("2XLgTmqxf6wu4zAwBAb2hvezGWht", alphabet: :flickr)
      {:error, "Invalid checksum."}

      iex> B58.version_decode58_check("2XLgTmqxf6wu4zAwBAb2hvezGWht0", alphabet: :btc)
      {:error, "non-alphabet digit found: \\"0\\" (byte 48)"}

      iex> B58.version_decode58_check("2QRkeNpTrYPiooUJjcubi1fprQ7aB8XvxSZ2wa4JQeBryrPVCvvkcY5NkXeptH6UzjKBBznXp58MWv4TTBvSHgeyjwPtY", alphabet: :ripple)
      {:ok,
  ...
  ## Examples
      ...
      iex> B58.version_binary("Chicken Recipe", 42)
      "*Chicken Recipe"

      iex> B58.version_binary("Chicken Recipe", <<255>>)
      <<255, 67, 104, 105, 99, 107, 101, 110, 32, 82, 101, 99, 105, 112, 101>>

      iex> B58.version_binary("Chicken Recipe", <<0>>) |> B58.version_encode58_check!()
  ...
  def version_binary(data, version) when is_binary(data) and is_integer(version) and version >= 0 and version <= 255 do
    <<version::unsigned-integer-size(1)-unit(8), data::binary>>
  end

  def version_binary(data, version) when is_binary(data) and is_binary(version) and byte_size(version) == 1 do
  ...
  defmacro alphabets() do
    alphabet_ids = Enum.map(unquote(Macro.escape(alphabet_meta)), fn %{alphabet_id: alphabet_id} -> alphabet_id end)
  ...
  for %{alphabet_id: alphabet_id, alphabet: alphabet} <- alphabet_meta do
    ...
    defp unquote(encode_body_fun)(n, acc) do
      quotient = div(n, 58)
      char = n |> rem(58) |> unquote(char_fun)()
