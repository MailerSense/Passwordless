defmodule Passwordless.Email.Guardian do
  ...
  # defp maybe_place_domain_under_review(%Domain{} = domain, state) when map_size(state) > 0 do
  #   {:ok, domain}
  # end

  # defp maybe_place_domain_under_review(%Identity{} = identity, _state), do: {:ok, identity}
