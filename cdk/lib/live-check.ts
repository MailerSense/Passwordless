...
export class LiveCheck extends cdk.Stack {
  public constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const dbName = "livecheck";
    const appName = "live-check";
    const clusterNamespaceRoot = "live.check";
    ...
    const clusterNamespace = new PrivateDnsNamespace(
      this,
      "cluster-namespace",
      {
    ...
    const imageName = "live-check-image";
    ...
    const migrationName = "live-check-migration-lambda";
